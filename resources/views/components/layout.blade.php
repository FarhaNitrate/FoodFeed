  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">FoodFeed</a></h4>
        @auth
        <div class="flex-row my-3 my-md-0">
          ...
          <a class="btn btn-sm btn-success mr-2" href="/write-review">Write a Review</a>
    ...
    @if (session()->has('failure')) <!-- Flash message -->
    <div class="container container--narrow"> 
    ...
    <!-- footer begins -->
        <footer class="border-top text-center small text-muted py-3 footer"> 
            <p class="m-0">Copyright &copy; {{date('Y')}} <a href="/" class="text-muted">FoodFeed</a>. All rights reserved.</p>
          </footer>
